/*
  # Update invite_user function

  1. Changes
    - Drop existing function first
    - Recreate with updated parameter names
    - Maintain same functionality with clearer parameter naming
...
-- Recreate the function with updated parameter names
