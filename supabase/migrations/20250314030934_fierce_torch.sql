/*
  # Fix Identity Creation in invite_user Function

  1. Changes
    - Add provider_id field to identities record
    - Use email as provider_id for email provider
    - Ensure proper identity_data structure
*/
...
-- Recreate the function with proper identity creation
...
BEGIN
  ...
  VALUES (
    ...
    'email'::text,
    user_email,  -- Use email as provider_id for email provider
    now(),
    now()
  );
