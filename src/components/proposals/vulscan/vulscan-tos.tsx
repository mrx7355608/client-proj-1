export default function VulscanTermsOfService() {
  return (
    <>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm leading-relaxed">
                ...
                support (as needed) at no charge during the normal business
                hours Monday through Friday from 8:00 a.m. to 6:00 pm per month.
                After hours, 2-hour notice, base rates of $78 per hour for work
                done outside the normal business hours Monday through Friday
                from 8:00 a.m. to 6:00 p.m., After hours services are based on
                one-hour minimum charge for services with 15-minute increments
                after the initial first hour. These rates are for labor only and
                do not include parts and/or materials that may be required. This
                contract will automatically renew for an additional 12-month
                term unless either party provides written notice of termination
                at least 60 days prior to the expiration of the current term.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed">
                ITX Solutions will invoice NSB Board of Realtors upon
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed">
                ...
                Agreement on its behalf is authorized to do so and may bind to
                all the terms and conditions contained herein and represents and
                warrants that such person is acting within the scope of his or
                her authority as an officer, director or duly authorized agent
                or employee of NSB Board of Realtors.
              </p>
            </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm leading-relaxed">
              <li>
                <span className="font-bold text-gray-900">Non-Exhaustive:</span>{" "}
                Vulnerability scans identify many known vulnerabilities, but no
                solution can guarantee the detection of every possible security
                gap.
              </li>
              <li>
              ...
              <li>
                <span className="font-bold text-gray-900">Remediation:</span>{" "}
                Implementation of remediation steps (e.g., patching or
                reconfigurations) is ultimately the responsibility of the client
                unless otherwise specified in an additional service scope
              </li>
            </ul>
          </div>
        </div>
